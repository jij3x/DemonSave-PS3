 ...
 * @returns {{ ids: number[], names: string[], itemsMap: Object }}
 */
export function _buildCategory(category) {
  ...
  const items = cfg.data[cfg.itemsKey];
 ...
 *
 * @param {Object} baseWeapons  frozen rel-upgrades.base_weapons
 * @param {Object} upgradePaths frozen rel-upgrades.paths
 ...
 *
 * @param {{upgrade_ref?: Array}} item  the weapon/shield/bow entry
